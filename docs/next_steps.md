...
7. ~~Windows packaging~~ — built on the `electron` branch: `desktop/` shell, first-run sprite download, CI workflow. See `PACKAGING.md`. Remaining: pick a host for the packs, upload them, tag a release.
